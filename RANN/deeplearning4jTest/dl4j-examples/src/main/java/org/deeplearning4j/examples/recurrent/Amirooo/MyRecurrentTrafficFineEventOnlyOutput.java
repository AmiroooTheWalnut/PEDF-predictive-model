...
public class MyRecurrentTrafficFineEventOnlyOutput {

    //BROKEN!!! BECAUSE IF ONLY EVENT BE PREDICTED, THEN HOW TO BUILD UP NEW TRANSACTION TO FEED NETWORK AGAIN!
    //EACH TIME NETWORK REQUIRES ALL FEATURES AND EVENTS OF A TIME STAMP!
    ...
    MyRecurrentTrafficFineEventOnlyOutput()
    {
        ...
        outputLayerBuilder.nOut(numOutput);
        ...
        INDArray labels = Nd4j.zeros(numCases+1, numOutput, largestSequence);

        String fileName= "F:/My_software_develops/BaggingPetriNetProject/DeepLearning4JTest/roadTrafficFinesLogANN_DATA_50000.csv";
...
//            wrapper.fit(data);
            ...
            //Save the model
            File locationToSave = new File("MyMultiLayerNetwork_EventOnly.zip");      //Where to save the network. Note: the file is in .zip format - can be opened externally
            ...
            File locationToSave = new File("MyMultiLayerNetwork_EventOnly.zip");
